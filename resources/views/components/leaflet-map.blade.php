<div class="card border-white shadow-sm p-4" style="max-width:100%; margin:auto; padding-bottom:30px;">
    ...
    <!-- Image + Map Row -->
    <div class="row g-4" style="border:2px solid #000; border-radius:12px; padding:20px; background:#f8f9fa;">
        ...
        <div class="col-md-6">
            <div id="pesoMap" style="height:350px; width:100%; border-radius:8px;"></div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    var map = L.map('pesoMap').setView([8.367491, 124.865093], 16);
    ...
    L.marker([8.367491, 124.865093], {icon: icon}).addTo(map)
        .bindPopup(`
            <div class="p-2 text-center">
                <h6 class="fw-bold mb-1 text-primary">PESO Location</h6>
                <p class="mb-2 xsmall">8.367491, 124.865093</p>
            </div>
        `);
